...
#define FN_LAY MO(FN_LAYER)
#define CP_LK LT(LAYER2, KC_NO)
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [UNIX_BASE] = LAYOUT_ansi_82(
        ...
        CP_LK,  KC_A,     KC_S,     KC_D,     KC_F,     KC_G,     KC_H,     KC_J,     KC_K,     KC_L,     KC_SCLN,  KC_QUOT,      KC_ENT,                 DB_TOGG,
        KC_LSFT,  KC_Z,     KC_X,     KC_C,     KC_V,     KC_B,     KC_N,     KC_M,     KC_COMM, KC_DOT,   KC_SLSH,   KC_RSFT,      KC_UP,
        KC_LCTL,  KC_LGUI,  KC_LALT,                KC_SPC,                              KC_RALT,  FN_LAY, KC_RCTL,           KC_LEFT, KC_DOWN,KC_RGHT
        ),
    ...
    [MAC_BASE] = LAYOUT_ansi_82(
        ...
        KC_GRV,   KC_1,     KC_2,     KC_3,     KC_4,     KC_5,     KC_6,     KC_7,     KC_8,     KC_9,     KC_0,     KC_MINS,      KC_EQL,   KC_BSPC,            KC_PGUP,
        KC_TAB,   KC_Q,     KC_W,     KC_E,     KC_R,     KC_T,     KC_Y,     KC_U,     KC_I,     KC_O,     KC_P,     KC_LBRC,      KC_RBRC,  KC_BSLS,            KC_PGDN,
        CP_LK,  KC_A,     KC_S,     KC_D,     KC_F,     KC_G,     KC_H,     KC_J,     KC_K,     KC_L,     KC_SCLN,  KC_QUOT,      KC_ENT,                       KC_HOME,
        KC_LSFT,  KC_Z,     KC_X,     KC_C,     KC_V,     KC_B,     KC_N,     KC_M,     KC_COMM,  KC_DOT,   KC_SLSH,      KC_RSFT,             KC_UP,
    ...
    [LAYER2] = LAYOUT_ansi_82(
        ...
        _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,            _______,            _______,
        _______,            _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,            _______,  _______,
        _______,  _______,  _______,                                BAT_LVL,                                _______,  _______,  _______,  _______,  _______,  _______
        ),
...
void leader_start_user(void) {
    ...
    uprintf("Leader Key Started");
}

bool process_record_user(uint16_t keycode, keyrecord_t *record) {
    // static uint16_t lead_layer_timer;
    ...
    switch (keycode) {
        case CP_LK:
            if (record->tap.count > 0) { // Key Is being tapped
                if (record->event.pressed) { // On Tap
                    leader_start();
                }
            } else {
