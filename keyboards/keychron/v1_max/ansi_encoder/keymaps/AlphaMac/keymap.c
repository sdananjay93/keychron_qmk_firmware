...
# define KC_MODD MT(MOD_LCTL | MOD_LGUI | MOD_LALT, QK_LEAD)
// clang-format off
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [MAC_BASE] = LAYOUT_ansi_82(
        ...
        KC_MODD,  KC_A,     KC_S,     KC_D,     KC_F,     KC_G,     KC_H,     KC_J,     KC_K,     KC_L,     KC_SCLN,  KC_QUOT,      KC_ENT,                       KC_HOME,
...
const uint16_t PROGMEM encoder_map[][NUM_ENCODERS][2] = {
    ...
    [LAYER3] = {ENCODER_CCW_CW(KC_VOLD, KC_VOLU)},
    [LAYER4] = {ENCODER_CCW_CW(KC_VOLD, KC_VOLU)},
    [LAYER5] = {ENCODER_CCW_CW(KC_VOLD, KC_VOLU)},
    [LAYER6] = {ENCODER_CCW_CW(KC_VOLD, KC_VOLU)},
